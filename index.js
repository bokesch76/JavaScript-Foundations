...
*/
const numerator = monthlyIR * (Math.pow((1 + monthlyIR), periods));
const denominator = (Math.pow((1 + monthlyIR), periods)) -1;

let mrate = principal * (numerator/denominator);
let monthlyRate = mrate.toFixed(2);
